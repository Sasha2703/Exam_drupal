...
class __TwigTemplate_1871dfd13b1cabb2069c75e6d0a778ee6d1909a3b8417018a86a930c6f4cd49f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["action_class"] ?? null)];
        // line 38
        $context["attributes"] = twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "setAttribute", [0 => "rel", 1 => "nofollow"], "method", false, false, true, 38);
        // line 39
        echo "
<div class=\"";
        // line 40
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, twig_join_filter($this->sandbox->ensureToStringAllowed(($context["classes"] ?? null), 40, $this->source), " "), "html", null, true));
        echo "\"><a";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["attributes"] ?? null), 40, $this->source), "html", null, true));
        echo ">";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 40, $this->source), "html", null, true));
        echo "</a></div>
";
    ...
    {
        return array (  69 => 40,  66 => 39,  64 => 38,  62 => 34,  61 => 33,  60 => 32,  59 => 30,  56 => 27,  52 => 25,  48 => 23,  46 => 22,  41 => 19,  39 => 17,);
    }
...
", "modules/contrib/flag/templates/flag.html.twig", "/var/www/web/modules/contrib/flag/templates/flag.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("escape" => 19, "clean_class" => 32, "join" => 40);
